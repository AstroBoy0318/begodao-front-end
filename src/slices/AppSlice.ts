...
export const loadAppDetails = createAsyncThunk(
  ...
  async ({ networkID, provider }: IBaseAsyncThunk, { dispatch }) => {
    ...
    const stakingVal = parseFloat(ethers.utils.formatUnits(stakingBalance, decimals).toString());
    const stakingTVL = stakingVal * marketPrice;
    ...
    const circSupply = totalSupply - stakingVal;
