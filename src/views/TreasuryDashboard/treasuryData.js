...
export const tooltipInfoMessages = {
  tvl: "Total Value Deposited, is the dollar amount of all BEGO staked in the protocol. This metric is often used as growth or health indicator in DeFi projects.",
  mvt: "Market Value of Treasury Assets, is the sum of the value (in dollars) of all assets held by the treasury.",
  rfv: "Risk Free Value, is the amount of funds the treasury guarantees to use for backing BEGO.",
  ...
  holder: "Holders, represents the total number of sBEGO Holders",
  staked: "BEGO Staked, is the ratio of sBEGO to BEGO (staked vs unstaked)",
  ...
  runway: "Runway, is the number of days sBEGO emissions can be sustained at a given rate. Lower APY = longer runway",
};
