...
export const tooltipInfoMessages = {
  ...
  holder: "Holders, represents the total number of BEGO (sPIP holders)",
  staked: "BEGO Staked, is the ratio of sPIP to BEGO (staked vs unstaked)",
  ...
  runway: "Runway, is the number of days sPIP emissions can be sustained at a given rate. Lower APY = longer runway",
};
